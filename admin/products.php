...
// } else {
    if($_GET['mid']) {
        ...
        mysqli_query($con,"delete from product where id ='$mid'");
                    ...
                    <div class="tm-block h-100" style="border-radius: 50px; background-color:rgba(255, 255, 255, 0.8);">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="add-products.php" class="btn btn-small btn-primary" style="border-radius: 50px;">Add New Product</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-product.php?editid=<?php echo $row['id'];?>" class="btn btn-primary link-view" style="border-radius: 50px;">Edit</a>
                                        </td>
                                        <td>
                                            <a href="products.php?mid=<?php echo $row['id'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')" style="border-radius: 50px;">Delete</a>
                                        </td>
                                    </tr>
