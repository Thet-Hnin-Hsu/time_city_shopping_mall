...
// } else {
    if(isset($_POST['update'])) {
        ...
        $query=mysqli_query($con, "update category set image='$newimage',name='$name',description='$desc' where id='$eid' ");
...
<head>
    ...
    <title>Edit Categories Page</title>
    <!--
...
<body style="background: url('img/dash-bg-03.jpg') center cover;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-xl navbar-light bg-light" style="border-radius: 50px; background-color:rgba(255, 255, 0, 0.8);">
                        ...
                        <?php
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="name" value="<?php  echo $row['name'];?>" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" style="border-radius: 50px;">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="description" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 mb-2">Description</label>
                                    <textarea class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" name="description" value="" rows="3" required style="border-radius: 50px;"><?php  echo $row['description'];?></textarea>
                                </div>
                                <div class="input-group mb-3">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 mx-auto mb-4">
                                <div class="tm-product-img-dummy mx-auto" style="border-radius: 50px;">
                                    <img src="img/<?php echo $row['image']?>" width="120px;">
                                </div>
