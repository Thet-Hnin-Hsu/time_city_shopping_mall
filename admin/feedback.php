...
// } else {
    if($_GET['bkid']) {
        ...
        mysqli_query($con,"delete from contact where id ='$bkid'");
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <tr>
                                        <td class="tm-product-name text-center"><?php  echo $row['name'];?></td>
                                        <td class="text-center"><?php  echo $row['email'];?></td>
                                        <td class="text-center"><?php  echo $row['message'];?></td>
                                        <td><a href="feedback.php?bkid=<?php echo $row['id'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                                    </tr>
                                    <?php 
                                        $cnt=$cnt+1;
                                    }?>
